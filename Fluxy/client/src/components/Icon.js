...
const icons = {
  ...
  gamepad: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M6 4a2 2 0 00-2 2v2a10 10 0 0016 0V6a2 2 0 00-2-2H6z"/>
      <path d="M4 8v2a10 10 0 0016 0V8"/>
    </svg>
  ),
  chat: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  fluxy: (
    <svg viewBox="0 0 32 32" fill="none">
      ...
      <path d="M8 10h10a6 6 0 010 12h-4" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
      <path d="M10 16h8" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
...
export function Icon({ name, className = '', size = 20, style }) {
  ...
  if (!icon) return null;
  return (
    <span className={`icon ${className}`} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: size, height: size, flexShrink: 0, ...style }}>
